...
{	  
    ...
    changeInflationLayerCost(3.0);
    changeInflationLayerRadius(0.2);	
...
void changeParameters2()
{
    ...
    changeInflationLayerCost(5.0);
    changeInflationLayerRadius(0.005);	
...
int main(int argc, char ** argv)
{
    ...
    getRobotPose();
    changeParameters2();
    while(!sendGoalPose(-1.644520,-0.356367,3.14));
    ...
    getRobotPose();
    changeParameters5();
    while(!sendGoalPose(0.585131,1.634950,3.14/2.0));
